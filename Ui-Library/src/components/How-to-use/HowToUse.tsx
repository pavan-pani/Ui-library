  ...
  return (
    <div className='howToUse'>
      <div className='step-main'>
        ...
        <div className='subHeading'>Click here to download the file and extraxt it in your local machine.</div>
      </div>
      <div className='step-main'>
        <img className='step-num' src={num2}></img>
        <div className='heading'>Insert into your project</div>
        <div className='subHeading'>insert the unziped folder into your project working directory.</div>
        <img className='file-path' src={filePath}></img>
      </div>
      <div className='step-main'>
        <img className='step-num' src={num3}></img>
        <div className='heading'>Refer Demo.txt file</div>
        <div className='subHeading'>Each compopont as a demo.txt file, which will help you to understand how use components</div>
      </div>
      <div className='step-main'>
        <img className='step-num' src={num4}></img>
        <div className='heading'>Add styles (Optional)</div>
        <div className='subHeading'>Each compopont as a .scss file, You change the components styles to match your design system</div>
      </div>
      <div className='step-main last-child'>
        <img className='step-num' src={num5}></img>
        <div className='heading'>Thats it. call the componets  </div>
